_base_ = [
    '../_base_/models/deeplabv3_unet_s5-d16.py', '../_base_/datasets/my_pectoralis.py',
    '../_base_/default_runtime.py', '../_base_/schedules/schedule_80k_cumulative.py'
]
...
train_pipeline = [
    ...
    dict(type='RandomRotate', prob=0.5, degree=(-10, 10)),
